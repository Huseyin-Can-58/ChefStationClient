package com.example.chefstation.Database
...
class LocalCartDataSource(private val cartDAO:CartDAO) : CartDataSource {
    ...
    override fun getItemWithAllOptionsInCart(uid: String, categoryId:String , foodId: String, foodSize: String, foodAddon: String): Single<CartItem> {
