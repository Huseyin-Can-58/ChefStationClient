...
class MyOrderDetailAdapter(internal var context: Context,
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if(!cartItemList[position].foodAddon.equals("Varsayılan")){
            ...
            if(addonModels != null){
                ...
                addonString.delete(addonString.length-1,addonString.length) // Son virgülü kaldırmak için
                holder.txt_food_addon!!.setText(StringBuilder("Eklenti: ").append(addonString))
            }
        }
        else{

            holder.txt_food_addon!!.setText(StringBuilder("Eklenti: Varsayılan"))
        }
