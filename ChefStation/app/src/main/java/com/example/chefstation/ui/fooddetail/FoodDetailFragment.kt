...
class FoodDetailFragment : Fragment(), TextWatcher {
    ...
    private fun submitRatingToFirebase(commentModel:CommentModel?) {
        ...
        // Önce yorumu Comment üzerine kaydetmek gerekir
    ...
    private fun addRatingToFood(ratingValue: Double) {
        ...
        FirebaseDatabase.getInstance()
                .getReference(Common.CATEGORY_REF)              // Kategoriyi seçmek
                .child(Common.categorySelected!!.menu_id!!)     // Menüyü seçmek
                .child("foods")                        // Yiyecek dizisini seçmek
                .child(Common.foodSelected!!.key!!)              // Keyi seçmek
                .addListenerForSingleValueEvent(object:ValueEventListener{
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if(dataSnapshot.exists())
                        {
                            ...
                            // Değişkenlerdeki veriyi güncellemek
    ...
    private fun displayInfo(it: FoodModel?) {
        ...
        // Varsayılan olarak ilk radyo butonun seçilmesi
                ...
                .subscribe(object: SingleObserver<CartItem> {
                    ...
                    override fun onSuccess(cartItemFromDB: CartItem) {
                        ...
                        if(cartItemFromDB.equals(cartItem)){
                            ...
                            // Eğer veri veri tabanında varsa sadece güncellemek
                            ...
                            cartDataSource.updateCart(cartItemFromDB)
                                ...
                                .subscribe(object: SingleObserver<Int> {
                                    ...
                                    override fun onSuccess(t: Int) {
                                        Toast.makeText(context,"Sepet Güncelleme Başarılı",Toast.LENGTH_SHORT).show()
                            ...
                            // Eğer veri veritabanında yoksa sadece ekle
                            ...
                            compositeDisposable.add(cartDataSource.insertOrReplaceAll(cartItem)
                                ...
                                .subscribe({
                                    ...
                                    // CounterFab'ı güncellemek için HomeActivity'e bir bildirim gönderilecek
                                    EventBus.getDefault().postSticky(CountCartEvent(true))
                                },{
    ...
    private fun showDialogRating() {
        ...
        builder.setTitle("Yemeği Puanla")
        builder.setMessage("Lütfen bilgileri doldurunuz")
