...
class HomeActivity : AppCompatActivity() {
    ...
    private fun showNewsDialog() {
        ...
        builder.setTitle("HABER SİSTEMİ")
        ...
        builder.setNegativeButton( "HAYIR",{dialogInterface, i ->
            ...
            FirebaseMessaging.getInstance().unsubscribeFromTopic(Common.NEWS_TOPIC)
                ...
                .addOnSuccessListener { aVoid:Void? ->
                    Toast.makeText(this,"Kayıt Silme İşlemi Başarılı!",Toast.LENGTH_SHORT).show()
                }})
        ...
        builder.setPositiveButton("GÜNCELLE") { dialogInterface, i ->
           ...
           // if(placeSelected != null) {
                ...
                if (TextUtils.isDigitsOnly(edt_name.text.toString())) {
                    Toast.makeText(this@HomeActivity, "Lütfen İsminizi Giriniz", Toast.LENGTH_SHORT).show()
                    return@setPositiveButton
                }

                if (TextUtils.isDigitsOnly(edt_address.text.toString())) {
                    Toast.makeText(this@HomeActivity, "Lütfen Adresi Seçiniz", Toast.LENGTH_SHORT).show()
                    return@setPositiveButton
                }

                 if (TextUtils.isDigitsOnly(edt_phone.text.toString())) {
                Toast.makeText(this@HomeActivity, "" + "Lütfen Telefon Numaranızı Giriniz", Toast.LENGTH_SHORT).show()
                return@setPositiveButton
            }
            ...
            FirebaseDatabase.getInstance()
                    ...
                    .addOnSuccessListener {
                       ...
                       // Common.currentUser!!.lng = update_data["lng"].toString().toDouble()
                        Toast.makeText(this@HomeActivity,"Bilgi Güncelleme Başarılı",Toast.LENGTH_SHORT).show()
                    }
  ...
  //          }
    ...
    private fun signOut(){
        ...
        val builder = androidx.appcompat.app.AlertDialog.Builder(this)
            builder.setTitle("Çıkış")
                    .setMessage("Gerçekten çıkmak istiyor musunuz?")
                    .setNegativeButton("Hayır",{dialogInterface, _ -> dialogInterface.dismiss()})
    ...
    fun onCategorySelected(event:CategoryClick) {
        ...
        if (event.isSuccess) {
            ...
            //Toast.makeText(this,event.category.name+" İçin Tıklayın",Toast.LENGTH_SHORT).show()
                                        ...
                                        .addListenerForSingleValueEvent(object:ValueEventListener{
                                            override fun onDataChange(p0: DataSnapshot) {
                                                if(p0.exists()){
                                                    ...
                                                    Toast.makeText(this@HomeActivity,"Değer bulunamadı",Toast.LENGTH_SHORT).show()
                                                }
                                                dialog!!.dismiss()
                                            }
